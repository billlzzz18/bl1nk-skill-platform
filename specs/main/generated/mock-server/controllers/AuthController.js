...
const authMeGET = async (request, response) => {
  await Controller.handleRequest(request, response, service.authMeGET);
};
...
module.exports = {
  ...
  authMeGET,
  authRegisterPOST,
  registerUser: authRegisterPOST,
  loginUser: authLoginPOST,
  getCurrentUser: authMeGET,
};
