...
export function ContextFilesPicker() {
  ...
  const isSmartContextEnabled =
    settings?.enableBl1nkPro && settings?.enableProSmartFilesContextMode;
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-[300px]">
                    {isSmartContextEnabled ? (
                      <p>
                        With Smart Context, bl1nk uses the most relevant files as
                        context.
                      </p>
                    ) : (
                      <p>By default, bl1nk uses your whole codebase.</p>
                    )}
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
          ...
          <TooltipProvider>
            {contextPaths.length > 0 ? (
              ...
              <div className="rounded-md border border-dashed p-4 text-center">
                <p className="text-sm text-muted-foreground">
                  {isSmartContextEnabled
                    ? "bl1nk will use Smart Context to automatically find the most relevant files to use as context."
                    : "bl1nk will use the entire codebase as context."}
                </p>
              </div>
            )}
          </TooltipProvider>
