...
import { VanillaMarkdownParser } from "./Bl1nkMarkdownParser";
import { CustomTagState } from "./stateTypes";
import { Bl1nkTokenSavings } from "./Bl1nkTokenSavings";

interface Bl1nkThinkProps {
  node?: any;
  children?: React.ReactNode;
}

export const Bl1nkThink: React.FC<Bl1nkThinkProps> = ({ children, node }) => {
  ...
  // If it's token savings format, render Bl1nkTokenSavings component
