...
const TEST_RESPONSES: Record<string, string> = {
  ...
  <bl1nk-add-dependency packages="deno"></bl1nk-add-dependency>
  
  EOM`,
  "add-non-existing-dep": `I'll add that dependency for you.
  
  <bl1nk-add-dependency packages="@angular/does-not-exist"></bl1nk-add-dependency>
  
  EOM`,
  "add-multiple-deps": `I'll add that dependency for you.
  
  <bl1nk-add-dependency packages="react-router-dom react-query"></bl1nk-add-dependency>
  
  EOM`,
  write: `Hello world
  <bl1nk-write path="src/hello.ts" content="Hello world">
