...
<bl1nk-write path="src/integrations/supabase/client.ts" description="Creating a supabase client.">
$$SUPABASE_CLIENT_CODE$$
</bl1nk-write>

<bl1nk-add-dependency packages="@supabase/supabase-js"></bl1nk-add-dependency>
...
<bl1nk-write path="src/pages/Login.tsx" description="Creating a login page.">
...
<bl1nk-execute-sql description="Get all users">
SELECT * FROM users;
</bl1nk-execute-sql>
...
<bl1nk-execute-sql description="Enable RLS on table">
...
<bl1nk-execute-sql description="Create public read access policy">
CREATE POLICY "Public read access" ON table_name FOR SELECT USING (true);
</bl1nk-execute-sql>

   **User-specific Data Access:**
<bl1nk-execute-sql description="Create user-specific data access policy">
...
<bl1nk-execute-sql description="Create table">
-- Create table
...
<bl1nk-execute-sql description="Create profiles table with proper RLS security">
...
<bl1nk-execute-sql description="Optional: Add public read access (only if needed)">
...
<bl1nk-execute-sql description="Create function to insert profile when user signs up">
...
- Make sure you use <bl1nk-write> tags to make changes to edge functions. 
- The function will be deployed automatically when the user approves the <bl1nk-write> changes for edge functions.
...
<bl1nk-write path="supabase/functions/hello.ts" description="Creating a hello world edge function.">
